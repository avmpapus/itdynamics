...
<head>
  ...
  <title>HTML | Itdynamics.com.ua</title>
  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url('/public/images/slider/html/HTML.svg.png')">
          <div class="caption">
...
<a href="/">Main</a> > HTML
        ...
        <div class="item" style="background-image: url('/public/images/slider/html/html-output.jpg')">
          <div class="caption">
...
<a href="/">Main</a> > HTML
        ...
        <div class="item" style="background-image: url('/public/images/slider/html/what-is-html.jpg')">
          <div class="caption">
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            ...
            -->
            <br>
            <h2><font color="black">HTML</font></h2>
          </div>
        </div>
      </div>
      <div class="text-center our-services">
        <div class="row">
          <div class="col-sm wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            Technology HTML/HTML5 is base all our the projects on JS, PHP. 
            HTML is HyperText Markup Language, it is showing the elements on page.
            </div>
          </div>
