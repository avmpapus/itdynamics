...
<head>
  ...
  <title>WordPress Development | Itdynamics.com.ua</title>
  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url('/public/images/slider/wp/wp.png')">
          <div class="caption">

          <div style="position:relative;left:-270px;">
<a href="/">Main</a> > WordPress
</div>


            <h1 class="animated fadeInLeftBig">Work with <span>WordPress</span></h1>
            <p class="animated fadeInRightBig">Shop development</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
        <div class="item" style="background-image: url('/public/images/slider/wp/blog5f352fc3b2393_wp.png')">
          <div class="caption">
...
<a href="/">Main</a> > WordPress
        ...
        <div class="item" style="background-image: url('/public/images/slider/wp/blog5feae4230520c_wordpres3s.png')">
          <div class="caption">
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            ...
            <h2><font color="black">WordPress Development</font></h2>
          </div>
        </div> 
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <p class="pull-right">Designed by <a href="/">Itdynamics</a></p>
          </div>
        </div>
      </div>
    </div>
