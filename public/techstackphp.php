...
<head>
  ...
  <title>Development with PHP | Itdynamics.com.ua</title>
  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url('/public/images/slider/php/PHP-logo.svg.png')">
          <div class="caption">
...
<a href="/">Main</a> > PHP
            ...
            <h1 class="animated fadeInLeftBig">Work with <span>PHP</span></h1>
            <p class="animated fadeInRightBig">Shop development</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
        <div class="item" style="background-image: url('/public/images/slider/php/meta-image.png')">
          <div class="caption">
...
<a href="/">Main</a> > PHP
        ...
        <div class="item" style="background-image: url('/public/images/slider/php/Screenshot_3.jpg')">
          <div class="caption">
      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            ...
            <h2><font color="black">Development with PHP</font></h2>
          </div>
        </div> 
      </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="450ms">
            <div class="service-info">
              <p>We have more 50 the projects with PHP. Among all the projects we have personal.</p>
            </div>
          </div>
